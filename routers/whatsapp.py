...
def format_grammar_response_whatsapp(response_text: str) -> str:
    """
    Format grammar response for WhatsApp - clean and structured without emojis
    """
                ...
                if command_response:
                    ...
                    if current_mode == "menu":
                        ...
                        if current_mode == "grammar":
                            ...
                            message_text = format_grammar_response_whatsapp(response.response_text)
                        else:
                            # Regular responses with mode indicator
                            mode_emoji = {
                                "chat": "💬", 
                                "vocabulary": "📚",
                                "dreams": "🌙",
